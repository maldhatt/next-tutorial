'use client'; // for Server-Side validation
...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  const [state, formAction] = useActionState(createInvoice, initialState); // return variables from useActionState
    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          {/* Check for each specific error using state */}
